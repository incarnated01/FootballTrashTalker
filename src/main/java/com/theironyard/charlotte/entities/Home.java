...
public class Home {
    ...
    List<Drive> driveObjects;

    public Home() {
    }

    public Home(String team, String opponent, String totfd, String totyds, String pyds, String ryds, String pen, String penyds, String trnovr, String pt, String ptyds, String ptavg, List<Drive> driveObjects) {
        this.team = team;
        ...
        this.ptyds = ptyds;
        this.ptavg = ptavg;
        this.driveObjects = driveObjects;
    }
    ...
    public List<Drive> getDriveObjects() {
        return driveObjects;
    }

    public void setDriveObjects(List<Drive> driveObjects) {
        this.driveObjects = driveObjects;
    }
}
